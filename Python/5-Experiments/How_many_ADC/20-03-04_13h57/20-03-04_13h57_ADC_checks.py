...
"""
    Get:
        - long single aquisition from Guzik
        - Plot n histograms 
...
#############################
n_aquisitions = 1 ; # The number of aquisition made with Guzik
l_data= 2**30 ; # The length of one aquisition
...
data_slice = empty((n_Hs,l_data//n_Hs), dtype = float );
