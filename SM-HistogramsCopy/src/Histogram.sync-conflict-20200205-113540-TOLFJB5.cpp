...
\
template void Histogram<BinType>::float_to_hist(double data, uint64_t L_data , double max , double bin_width );\
template void Histogram<BinType>::float_to_hist(float data, uint64_t L_data , float max , float bin_width );
