...
template <class BinType>
double moment2D(BinType* histogram, uint64_t nofbins, uint exp_x = 0 , uint exp_y = 0 , double bin_centre = 0 , double bin_width = 1.0);

template <class BinType>
double cumulant_rr(BinType* histogram, uint64_t nofbins, double bin_centre = 0 , double bin_width = 1.0);

template <class BinType>
double cumulant_ss(BinType* histogram, uint64_t nofbins, double bin_centre = 0 , double bin_width = 1.0);

template <class BinType>
double cumulant_rrss(BinType* histogram, uint64_t nofbins, double bin_centre = 0 , double bin_width = 1.0);
