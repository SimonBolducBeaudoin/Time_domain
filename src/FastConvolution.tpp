...
template <class OutputType, class KernelType, class DataType, class ComplexType>
void Mother_FastConvolution<OutputType,KernelType,DataType,ComplexType>::set_L_FFT( uint32_t L_FFT )
{
	this->L_FFT = L_FFT;
...
template <class OutputType, class KernelType, class DataType, class ComplexType>
void Mother_FastConvolution<OutputType,KernelType,DataType,ComplexType>::set_n_threads( int n_threads )
{
...
template <class OutputType, class KernelType, class DataType, class ComplexType>
void Mother_FastConvolution<OutputType,KernelType,DataType,ComplexType>::print_all_attributes()
{
