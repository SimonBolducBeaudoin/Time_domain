...
TimeQuad<FloatType,DataType>::TimeQuad
(	
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::checks()
{
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::cast_and_alloc()
{
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::set_L_FFT( uint32_t L_FFT )
{
	this->L_FFT = L_FFT;
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::make_kernels()const
{
	// Abscisse
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::print_all_attributes()
{
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::execute()
{
...
template <>
void TimeQuad<float,int16_t>::Conv_FFT_kernel(const float* Input, complex_f* Output )
{	
...
template <>
void TimeQuad<double,int16_t>::Conv_FFT_kernel(const double* Input, complex_d* Output)
{
	//// Tries to load wisdom if it exists
...
template <>
void TimeQuad<float,int16_t>::Conv_FFT(const float* F ,const int16_t* G , float* H )
{
	// Tries to load wisdom if it exists
	fftwf_import_wisdom_from_filename("FFTWF_Wisdom.dat");
...
template <>
void TimeQuad<double,int16_t>::Conv_FFT(const double* F ,const int16_t* G , double* H )
{
...
template <class FloatType, class DataType>
void TimeQuad<FloatType,DataType>::Conv_Directe( FloatType* f , DataType* g , FloatType* h)const
{
	// Begenning
